...
<div class="container-fluid">
  ...
  <div class="row row-select">  
    <div class="col">
      <img id="imgJuego2" src="../media/juego2/juego2.png" height="75%" width="80%" style="margin:auto; display: block;">
    </div>
    <div class="col">
  ...
  <div class="container">
    ...
    <!-- <div id="juego2" class="divJuego">
      ...
      <div class="container" id="container_game2">
        <div class="row p-3" id="plantas" class="plantas" >
           div para la plantas 
          <div id="plantas" class="plantas" draggable="true" style= margin:30px>
              <img id="bambu" class="plantas" src= <?php// echo $ruta . "media/juego2/bambu.svg"?> width="100" height="100"alt="bambu">
    ...
    <div id="juego4" class="divJuego">
      ...
      <div class="row row-puntos">
        ...
        <div class="col">
          <h4 class="infoRow" id="time-left">10</h4>
        </div>
      </div>
      <!-- row elementos -->
      <div class="row">
    ...
    <div id="myModal" class="modal" tabindex="-1" role="dialog">
      <div class="modal-dialog" role="document">
        ...
        <div class="modal-footer">
          <form action="../php_controllers/insertDataJuegos.php" method="POST">
            <input type="hidden" id="puntos" name="puntos" value="">
            <button type="submit" id="BtnKeep" class="btn btn-primary">Quedarse puntos</button>
          </form>
