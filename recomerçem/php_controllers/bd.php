...
//guardar datos juegos, puntos, tipo juego = 1, id user = $_SESSION["id"]
function insertDataGame($puntos){
    $conn = connect();
    $stmt = $conn -> prepare("INSERT INTO juegos (tipo_juego, puntos, id_usuario) VALUES (1, :puntos, :id_usuario)");
    $stmt->bindParam(':puntos',$puntos);
